...
export class Issue {
    ...
    static lexical(message: string, severity: IssueSeverity = IssueSeverity.ERROR, position: Position = null): Issue {
        return new Issue(IssueType.LEXICAL, message, severity, position);
    }

    static syntactic(message: string, severity: IssueSeverity = IssueSeverity.ERROR, position: Position = null): Issue {
        return new Issue(IssueType.SYNTACTIC, message, severity, position);
    }

    static semantic(message: string, severity: IssueSeverity = IssueSeverity.ERROR, position: Position = null): Issue {
